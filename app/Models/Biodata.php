...
class Biodata extends Model
{
    ...
    protected $fillable = [
        ...
        'reference_code',
        'admin_comment',
        // Zawajuna-style fields
        'identifier', 'kounia', 'whatsapp', 'nationality', 'origine', 'spoken_langage',
        'boys', 'girls', 'dependentchildren', 'children_details', 'polygamy',
    ...
    {
        return $this->hasMany(Photo::class, 'biodata_id');
    }

    public function approvedPhotos()
    {
        return $this->photos()->where('approved', true)->orderBy('display_order');
    }
}

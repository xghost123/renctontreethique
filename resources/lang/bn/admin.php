...
return [
    ...
    'listbox' => [
        ...
        'title_available' => 'লগইন করু',
        'title_selected' => 'লগইন করুন',
    ],
    'grid_items_selected' => '{n} টি আইটেম নির্বাচিত হয়েছে',
    'prev' => 'পূর্ববর্তী',
    'next' => 'পরবর্তী',
    'quick_create' => 'দ্রুত তৈরি করুন',
    'delete_file_on_save' => 'আপনি কি নিশ্চিত যে আপনি সংরক্ষণ করার পরে এই ফাইলটি মুছে ফেলতে চান?',
    'select' => 'লগইন করু',
    'no_rows_selected' => 'লগইন করু',
];

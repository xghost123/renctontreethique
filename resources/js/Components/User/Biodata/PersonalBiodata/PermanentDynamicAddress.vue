...
// initializing
const innerHTML = ref('');
const selectedPermanentUpazilaAndUnionParishad = ref(props.permanentAddress.selectedUpazila == null || props.permanentAddress.selectedUnionParishad == null ? props.translations.biodata_form.personal_biodata.permanent_address_title : props.permanentAddress.selectedUpazila +' - '+ props.permanentAddress.selectedUnionParishad);
...
const handleLineClicks = (e) => {
    ...
    if ( clickedAction === 'goBackHandler' ) {
        ...
        selectedPermanentUpazilaAndUnionParishad.value = selectedUpazila.value + ' - ' + selectedUnionParishad.value;
        isHidden.value = true;
        ...
        <div class="main-search-option-input">
            <div class="od-location-dropdown od-field-type__location od-biodata-search-control" data-field_id="10">
                <button @click="addressHandler" class="od-location-dropdown-trigger block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                    {{ selectedPermanentUpazilaAndUnionParishad }}
                </button>
